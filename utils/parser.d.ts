...
declare function getRegions(headers: AudioSfzHeader[]): any;
...
export { findEnd, getRegions, opcodesToObject, parseSfz, processDirective, processHeader, processOpcode, processOpcodeObject, processVariables, setParserLoader, };
